...
.b[Project] Get the data together!
...
.b[Boosted residuals: The expansion]

.note[Recall:] Boosting trains 
- .pink[successive models] $\color{#e64173}{\hat{f_{i}}}(y,x)$
- on .orange[previous models' residuals], $\color{#FFA500}{r_{i-1}}$ (shrunk by $\color{#6A5ACD}{\lambda}$)
...
.b[Comparing boosting parameters]—more trees!
...
.b[Comparing boosting parameters]—even more trees!
...
.b[Comparing boosting parameters]—and even more trees!
...
1. [Boosting](#boost-intro)
  ...
  - [Algorithm](#boost-alg)
  - [In R](#boost-r)
  - [Expanding residuals](#boost-expand)
